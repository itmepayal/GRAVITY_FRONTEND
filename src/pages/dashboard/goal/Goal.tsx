...
export function Goal() {
    ...
    const handleEditGoal = (g: any) => {
        ...
        if (g.targetDate) setTargetDate(new Date(g.targetDate).toISOString().split("T")[0]);
        setIsModalOpen(true);
    };
    ...
    const handleDelete = (goalId: string) => {
        deleteGoal(goalId, { onSuccess: () => refetch() });
    };
                    ...
                    {isLoadingGoals ? (
                        ...
                        <div className="flex flex-col items-center justify-center py-16 text-center">
                            ...
                            <p className={`${COMMON_CLASSES.headingSubtitle} mt-1 max-w-md`}>
                                No OKR objectives match your filter. Create a new goal to start tracking progress.
                            </p>
                            <button
                                onClick={handleOpenCreateModal}
                    ...
                    <div className={COMMON_CLASSES.modalShell}>
                        <div className="flex items-center justify-between border-b border-[#0F2D29]/15 p-4">
                            ...
                            >
                                ...
                                {editingGoalId ? "Edit Workspace Goal" : "Create Workspace Goal"}
                            </h3>
                            <button
