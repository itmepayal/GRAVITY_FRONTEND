...
export function Calendar() {
    ...
    // Start & End dates of month for query
            ...
            <main className="mx-auto w-full max-w-[1600px] flex-1 space-y-6 p-4 sm:p-6 lg:p-8">
                ...
                <div className="border border-[#0F2D29]/15 bg-white p-4 shadow-2xs">
                    <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                        ...
                        {/* Right Controls: Search, Type Filter & New Event */}
                        <div className="flex flex-wrap items-center gap-3">
                            {/* Search */}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                        ...
                        <div className="grid grid-cols-7 gap-px bg-[#0F2D29]/15 border-x border-b border-[#0F2D29]/15">
                            ...
                            {[...Array(daysInMonth)].map((_, i) => {
                                ...
                                return (
                                    <div
                                        key={`day-${dayNum}`}
                                        className={`min-h-[120px] bg-white p-2 transition hover:bg-emerald-50/20 flex flex-col ${isToday ? "bg-emerald-50/40 ring-2 ring-[#0F8A65] ring-inset" : ""
                                            }`}
                                    >
                                        {/* Day header */}
                                        <div className="flex items-center justify-between mb-1.5">
                                            <span
                                                className={`${FONT_GOLDMAN} flex h-6 w-6 items-center justify-center text-xs font-bold ${isToday
                                            ...
                                            {dayEvents.length > 0 && (
                                                <span className={`${FONT_POPPINS} text-[10px] font-semibold text-[#5B6E68] bg-[#0F2D29]/6 border border-[#0F2D29]/10 px-1.5 py-0.5`}>
                                                    {dayEvents.length} ev
                                                </span>
                                            )}
                                        </div>
                                                    ...
                                                    >
                                                        <div className="flex items-center justify-between gap-1">
                                                            <div className="flex items-center gap-1 min-w-0">
                                                                ...
                                                                <span className="truncate font-semibold text-[#0F2D29]">{ev.title}</span>
                                                            </div>
                    ...
                    {/* Right 1 Col: Upcoming Agenda Stream (Matching Workspace Activity Panel) */}
                    <div className="border border-[#0F2D29]/15 bg-white p-5 shadow-2xs flex flex-col">
                        <div className="mb-4 flex items-center justify-between border-b border-[#0F2D29]/10 pb-3">
                            <h3 className={`${COMMON_CLASSES.headingTitle} text-sm flex items-center gap-2`}>
                                    ...
                                    return (
                                        ...
                                        >
                                            <div className="flex items-center justify-between">
                                                <span className={`${FONT_GOLDMAN} text-[10px] uppercase border px-2 py-0.5 font-bold ${style.bg}`}>
                                                    {ev.type}
                                                </span>
                                                <span className={`${FONT_POPPINS} text-[10.5px] font-semibold text-[#5B6E68]`}>
                                                    {dateStr} · {timeStr}
                                                </span>
                                            </div>

                                            <div className="flex items-center justify-between">
                                                <h4 className={`${FONT_GOLDMAN} text-xs font-bold text-[#0F2D29] line-clamp-1`}>
                                                    {ev.title}
                                                </h4>
                                                <button
                                                    onClick={() => handleEditEvent(ev)}
