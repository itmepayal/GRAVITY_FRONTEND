...
export function TimeLine() {
  ...
  const handleEditMilestone = (m: any) => {
    ...
    if (m.startDate)
      setStartDate(new Date(m.startDate).toISOString().split("T")[0]);
  ...
  const handleDeleteClick = (m: any) => {
    setDeleteTarget({ id: m._id || m.id, title: m.title });
          ...
          {isLoadingMilestones ? (
            ...
            <div className="flex flex-col items-center justify-center py-16 text-center">
              ...
              <p className={`${COMMON_CLASSES.headingSubtitle} mt-1 max-w-md`}>
                No milestones match your criteria for this project. Add your
                first milestone to create the roadmap.
              </p>
              <button
                onClick={handleOpenCreateModal}
