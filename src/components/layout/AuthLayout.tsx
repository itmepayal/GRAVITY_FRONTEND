...
export const AuthLayout = ({ title, description, panelContent, children }: AuthLayoutProps)  => {
  return (
    <div className="fixed inset-0 z-50 flex bg-white">
      <div className="relative hidden lg:flex lg:w-[46%] xl:w-[42%] flex-col justify-between overflow-hidden bg-[#0F2D29] px-12 py-10">
        ...
        <div className="pointer-events-none absolute -top-24 -right-24 w-[420px] h-[420px] rounded-full opacity-20 blur-3xl bg-[radial-gradient(circle,_#8FE3C4_0%,_transparent_70%)]" />
        <div className="pointer-events-none absolute -bottom-32 -left-24 w-[380px] h-[380px] rounded-full opacity-10 blur-3xl bg-[radial-gradient(circle,_#E98A57_0%,_transparent_70%)]" />
        ...
        <div className="relative z-10 flex flex-col gap-8 max-w-[420px]">
          <div className="flex flex-col gap-3">
            ...
            <p className="text-[#B7CFC7] text-[14px] leading-relaxed">{description}</p>
          </div>
      ...
      <div className="relative flex flex-1 flex-col items-center justify-center bg-white px-6">
        <div className="flex flex-col items-center gap-6 w-full max-w-[380px] animate-[fade-in_0.5s_ease-out]">
          <div className="flex lg:hidden items-center gap-2.5">
            <GravityMarkLoader step={1} />
            <span className="text-[#0F2D29] text-[17px] font-semibold">Gravity</span>
          </div>
