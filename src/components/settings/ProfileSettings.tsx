            ...
            <div className="relative shrink-0">
              {photoPreview ? (
                <img
                  src={photoPreview}
                  alt="Profile"
                  className="h-14 w-14 rounded-xl object-cover ring-2 ring-[#8FE3C4]/25"
                />
              ) : (
                <div className="flex h-14 w-14 items-center justify-center rounded-xl bg-[#8FE3C4] text-[17px] font-bold text-[#0F2D29] ring-2 ring-[#8FE3C4]/25">
                  {initials}
                </div>
              )}
              <button
