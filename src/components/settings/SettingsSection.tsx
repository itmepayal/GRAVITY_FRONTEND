...
export function SettingsSection({
  ...
  return (
    <section
      id={id}
      className={cn(
        "scroll-mt-24 overflow-hidden rounded-2xl border border-[#0F2D29]/12 bg-white shadow-xs",
        className,
      )}
    >
      <header className="flex items-center gap-3 border-b border-[#0F2D29]/8 bg-gradient-to-r from-[#0F2D29]/[0.03] to-transparent px-5 py-4 sm:px-6">
